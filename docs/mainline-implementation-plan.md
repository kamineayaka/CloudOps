...
| 阶段 | 主题 | 任务数 | 完成 | 产出 |
|------|------|--------|------|------|
| ML-0 | 对齐与契约 | 4 | 0 | 愿景落地、API/领域契约、成功指标 |
| ML-1 | 资产分组与对话目标 | 5 | 0 | Group、目标绑定、工具范围 |
| ML-2 | Architecture SSOT v2 | 6 | 0 | 分区、结构化事实、版本、出处 |
| ML-3 | Proposal 流水线 | 6 | 0 | 提案→审阅→合并→回滚→审计 |
| ML-4 | Agent 写回与 L0/L1/L2 | 6 | 0 | 分类器、提案工具、自动/半自动策略 |
| ML-5 | Work Log 一等公民 | 4 | 0 | 会话绑定、晋升规则、索引 |
| ML-6 | RAG 主线化 | 5 | 0 | 范围检索、再索引、反模式消除 |
| ML-7 | 知识治理与权限 | 4 | 0 | ACL、提案审批角色、越权拒绝 |
| ML-8 | 前端体验与可观测 | 5 | 0 | 架构视图、提案 UI、指标与演示剧本 |
...
### [ ] ML-0-02 — 领域契约：`docs/mainline-domain-model.md`
...
### [ ] ML-0-03 — API/WS 契约草案：`docs/mainline-api-contracts.md`
...
### [ ] ML-1-05 — 分组与 Architecture 分区键对齐
...
### [ ] ML-2-02 — 结构化事实表 `architecture_fact`
...
### [ ] ML-2-03 — Architecture 读写 API v2
...
### [ ] ML-4-02 — ChangeClassifier（L0/L1/L2）
...
### [ ] ML-4-03 — Agent 工具：`propose_architecture_update`
...
### [ ] ML-6-02 — 替换「整本 summary 塞 prompt」
...
### [ ] ML-7-01 — 资产范围 ACL（与 OPT/ARCH-A0 统一）
